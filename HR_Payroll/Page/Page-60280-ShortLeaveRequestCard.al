page 60280 "Short Leave Request Card"
{
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        //Rec.TESTFIELD("Pay Period"); //08.09.2021 @Ramesh
                        // Start 26.06.2020                        
                        ShortLeaveLineRecL.Reset();
                        ShortLeaveLineRecL.SetRange("Short Leave Request Id", Rec."Short Leave Request Id");
                        ShortLeaveLineRecL.SetRange("Employee Id", Rec."Employee Id");
                        if ShortLeaveLineRecL.FindFirst() then begin
                            // // // IF (ShortLeaveLineRecL."Requesht Date" <= Rec."Pay Period Start") THEN
                            // // //     ERROR(ReqDateErr, Rec."Pay Period");

                            // // // IF (ShortLeaveLineRecL."Requesht Date" >= Rec."Pay Period End") THEN
                            // // //     ERROR(ReqDateErr, Rec."Pay Period");
                        end;
                        // Stop 26.06.2020
                        LineRec.RESET;
    ...
    var
        ...
        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
        ShortLeaveWF_: Codeunit InitCodeunit_Short_Leave_Req;
        VisibBool: Boolean;

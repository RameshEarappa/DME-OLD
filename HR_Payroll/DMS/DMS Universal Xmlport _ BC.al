...
*/
    ...
    begin
        ...
        lrecItemJnl.Reset();
        if lrecItemJnl.FindSet() then BEGIN
            repeat
                ...
                IF (lrecItemJnl."Serial No." <> '') OR (lrecItemJnl."Lot No." <> '') THEN BEGIN
                    ...
                    lcuCreateResEntry.CreateReservEntryFor(
                                    ...
                                    lrecItemJnl."Entry Type", // ForSubtype: Integer; 
                                    lrecItemJnl."Journal Template Name",// ForID: Code[20]; 
                                     lrecItemJnl."Journal Batch Name",// ForBatchName: Code[10];
                                    0, //prod order line// ForProdOrderLine: Integer;
                                    lrecItemJnl."Line No.", //source ref no.//  ForRefNo: Integer;
                                    lrecItemJnl."Qty. per Unit of Measure",// ForQtyPerUOM: Decimal; 
                                    lrecItemJnl.Quantity,// Quantity: Decimal;
                                    lrecItemJnl."Quantity (Base)",// QuantityBase: Decimal; 

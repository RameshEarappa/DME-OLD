table 60040 "Leave Request Header"
{
    ...
    begin
        ...
        if l_LeaveType.FINDFIRST then begin
            ...
            if l_LeaveType."Accrual ID" = '' then begin
                if not l_LeaveType."Allow Negative" then begin
                    ...
                    IF AccountingPeriod.FINDLAST THEN BEGIN
                        ...
                        //LeaveRequestHeader2.SETFILTER("Leave Request ID",'<>%1',"Leave Request ID");
                        LeaveRequestHeader2.SETRANGE("Leave Type", "Leave Type");
                        //LeaveRequestHeader2.SETRANGE("Start Date",AccountingPeriod."Starting Date",12319999D);
                        //AdvancePayrollSetup.GET;
            ...
            if l_LeaveType."Accrual ID" <> '' then begin
                ...
                // Employee.GET(LeaveRequestHeader2."Personnel Number");
    ...
    begin
        AdvaceSetup.Reset();
        AdvaceSetup.Get();
        LeaveRequestHeader.TESTFIELD("Leave Type"); //21.10.2020
    ...
    begin
        ...
        //     end else begin
        //Commited based on Venkat 30.09.2021

page 70172 "Leave Request Card ESS"
{
                    ...
                    begin
                        ...
                        if LeaveRequestHeader.FINDFIRST then begin
                            if LeaveRequestHeader."Leave Days" = 0 then
                                ERROR('Leave days cannot be zero');
                            LeaveRequestHeader.TESTFIELD("Workflow Status", LeaveRequestHeader."Workflow Status"::Released);
                ...
                action("Duty Resumption")
                {
                    ...
                    begin
                        ...
                        if "Leave Cancelled" then
                            Error('Leave Cancellation already processed, cannot process Duty Resumption');
                        CreateDutyResumptionEntry;
                    end;
                }
